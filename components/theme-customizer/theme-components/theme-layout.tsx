...
const ThemeLayout = () => {
	...
	return (
		<div className='theme-setting-item'>
			<h6 className='font-medium text-base mb-3'>{t("theme-layout")}</h6>

			<div className='grid grid-cols-3 gap-4'>
				{layouts.map((item, index) => (
					<div className='' key={index}>
						<div
							className={`cursor-pointer border border-neutral-300 flex items-center justify-center hover:bg-primary/10 duration-300 h-[92px] rounded-md ring-2 dark:border-slate-500 ${
								layout === item.text
						...
						<h6
							className={`text-center capitalize text-sm font-medium pt-2 cursor-pointer hover:text-blue-500 ${
								layout === item.text

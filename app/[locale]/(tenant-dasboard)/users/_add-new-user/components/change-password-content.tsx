...
import { addNewUserType } from "@/lib/zod";

interface ChangePasswordContentProps {
	register: UseFormRegister<addNewUserType>;
	errors: FieldErrors<addNewUserType>;
}
		...
		<div>
			...
			<div className='mb-5'>
				<Label
					...
					{t("new-password-labe")} <span className='text-red-600'>*</span>
				</Label>
